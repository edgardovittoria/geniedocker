...
# !!! Main.UserApp is configured as an alias for Main.Solvergenie and you might encounter it in some tests
using Main.Solvergenie, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Solvergenie tests" begin
  @includetests ARGS
end
